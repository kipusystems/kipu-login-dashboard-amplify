function Table(props){
  ...
  var items = props.instances.map(function(inst){
    return(
      <tr className="tw-border-solid tw-border-b tw-border-gray-200 hover:tw-bg-k-purple-50 tw-group" key={inst.id}> 
        <td className="tw-px-2 tw-text-left sm:tw-text-sm md:tw-text-md tw-py-3">{inst.locationName}</td>
        ...
        <td className="tw-px-2 tw-py-3"><a href="#"></a> 
